<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Returns.aspx.cs" Inherits="AgnesWS.Screens.Returns" %>
...
<body>
  ...
  <table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="40" align="left" valign="middle" class="titulo">Returns   </td>
    </tr>
  </table>
</div>
    	  ...
    	  <tr>
    	        ...
    	        <td height="35" align="center" valign="top"> <br />
    	            ...
    	            <tr>
    	              <td width="120" align="right">
                            <asp:Label ID="Label8" runat="server" Text="Return Invoice" CssClass="txt_login2"></asp:Label>
    	              </td>
    	              <td width="10" align="right">&nbsp;</td>
    	              <td width="170">
                           <asp:TextBox ID="txtReturnInvoice" runat="server" CssClass="form_Form"></asp:TextBox>
    	              </td>
  	              </tr>
  	            </table>
   	           </td>
            ...
            providerName="System.Data.SqlClient"> </asp:SqlDataSource>
             ...
             <asp:Panel ID="Panel2" runat="server"  ScrollBars="Both" style="width:1000px;height:500px;">
    	          <asp:GridView ID="ReturnHeaderGrid" DataSourceID="SQL_ReturnHeader" runat="server"  DataKeyNames="ID" AutoGenerateColumns="False" OnRowCommand="ReturnHeaderGrid_RowCommand" EmptyDataText="No Returns Found" AllowSorting="True" OnSelectedIndexChanged="ReturnHeaderGrid_SelectedIndexChanged"  OnSorting="ReturnHeaderGrid_Sorting" OnRowDataBound="ReturnHeaderGrid_RowDataBound" AllowPaging="true" OnPageIndexChanging="ReturnHeaderGrid_PageIndexChanging" PageSize="10" CssClass="Grid">
    	            <Columns>
    	              <asp:CommandField HeaderText="Select" HeaderStyle-ForeColor="Black" ShowSelectButton="True" />
    	                <asp:BoundField DataField="ID" HeaderText="Invoice Number" SortExpression="ID"/>
    	               <asp:BoundField DataField="Customer" HeaderText="Customer" SortExpression="Customer"/>
    	              <asp:BoundField DataField="ReturnDate" DataFormatString="{0:MM/dd/yyyy}" HeaderText="Return Date" SortExpression="ReturnDate" />
    	              <asp:BoundField DataField="Warehouse" HeaderText="Warehouse" SortExpression="Warehouse"/>
    	              <asp:BoundField DataField="ReturnBy" HeaderText="Return Done By" SortExpression="ReturnBy"/>
            ...
            providerName="System.Data.SqlClient"> </asp:SqlDataSource>
                <asp:Panel ID="Panel1" runat="server"  ScrollBars="Both" style="width:1000px;height:200px;">
    	          <asp:GridView ID="ReturnDetailGrid" DataSourceID="SQL_ReturnDetail" runat="server"  DataKeyNames="ID" AutoGenerateColumns="False" AllowSorting="True" OnSorting="ReturnDetailGrid_Sorting" OnRowDataBound="ReturnDetailGrid_RowDataBound" CssClass="Grid">
    	            <Columns>   	             
        ...
        <tr>
                    <td colspan="4">
    	              ...
    	              <td width="170" align="center">
                               <asp:Button ID="NewReturn" CssClass="btn_saless" runat="server" Text="New Return" onclick="NewReturn_Click"/>
