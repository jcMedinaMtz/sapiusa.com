<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewReturn.aspx.cs" Inherits="AgnesWS.Screens.NewReturn" %>
    ...
    <form id="form2" runat="server" defaultbutton="btn_AddItem">
        ...
        <div id="titulo_100pe">
            <table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td height="40" align="left" valign="middle" class="titulo">Return and Sale</td>
                </tr>
            </table>
        </div>
                ...
                <table id="Outertable" width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td align="center" valign="top">
                            ...
                            <table id="Innertable" width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                         ...
                                         <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="120" align="right">
                                                    ...
                                                    <asp:Label ID="Label8" runat="server" Text="Loan Number" CssClass="txt_login2"></asp:Label>

                                                </td>
                                                <td width="10" align="right">&nbsp;</td>
                                                <td width="100">

                                                    <asp:TextBox ID="txtLoanNumber" runat="server" CssClass="form_Form"></asp:TextBox>
                                         ...
                                         <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="100" align="right">
                                                    ...
                                                    <asp:Label ID="Label9" runat="server" Text="Payment Status"></asp:Label>
                                        ...
                                        <br />
                                         <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <asp:TextBox ID="TxtReturnDate" runat="server" CssClass="form_Form"></asp:TextBox>
                                ...
                                <tr>
                                    <!-- Inner table row 3 starts -->
                                    <td height="35" colspan="4" align="left" valign="middle"> <br />
                                       <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="80" align="right">
                                                    <asp:Label ID="Label2" runat="server" Text="Sale Notes" CssClass="txt_login2"></asp:Label>
                                                </td>
                                                <td width="10" align="right">&nbsp;</td>
                                                <td width="400">

                                                    <asp:TextBox ID="txtSaleNotes" Width="400" TextMode="MultiLine" Height="50px" runat="server" CssClass="form_Form"></asp:TextBox>

                                                </td>
                                                 <td width="10" align="right">&nbsp;</td>
                                                 <td width="80" align="right">
                                                    <asp:Label ID="Label7" runat="server" Text="Return Notes" CssClass="txt_login2"></asp:Label>
                                                </td>
                                                <td width="10" align="right">&nbsp;</td>
                                                <td width="400">

                                                    <asp:TextBox ID="txtReturnNotes" Width="400" TextMode="MultiLine" Height="50px" runat="server" CssClass="form_Form"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="center" valign="top">
                            ...
                            <asp:Panel ID="Panel2" runat="server" ScrollBars="Both" Style="width: 1000px; height: 400px;">
                                <asp:GridView ID="DetailsGrid" ShowFooter="true" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ID" ReadOnly="true" HeaderText="Detail ID" HeaderStyle-ForeColor="Black" ItemStyle-HorizontalAlign="Right" />
                                        <asp:BoundField DataField="HeaderID" ReadOnly="true" HeaderText="Loan Number" HeaderStyle-ForeColor="Black" ItemStyle-HorizontalAlign="Right" />
                                        <asp:BoundField DataField="ItemNo" ReadOnly="true" HeaderText="Item Number" HeaderStyle-ForeColor="Black" />
                                        ...
                                        <asp:BoundField DataField="QuantitySent" ReadOnly="true" HeaderText="Loan Items" HeaderStyle-ForeColor="Black" ItemStyle-HorizontalAlign="Right" />
                                        <asp:BoundField DataField="QuantityReturned" HeaderText="Returned Items" HeaderStyle-ForeColor="Black" ItemStyle-HorizontalAlign="Right" />
                                        <asp:BoundField DataField="QuantityForSale" HeaderText="Sale Items" HeaderStyle-ForeColor="Black" ItemStyle-HorizontalAlign="Right" />
                                        <asp:BoundField DataField="UnitCost" ReadOnly="true" FooterText="Total" HeaderText="Unit Price" HeaderStyle-ForeColor="Black" ItemStyle-HorizontalAlign="Right" />
                            ...
                            <table width="500px">
                                <tr>
                                    <td align="right" valign="top">
                                        <br />
                                        <br />
                                        <asp:HiddenField ID="HiddenReturnCompleted" runat="server" Value="0" />
                                        ...
                                        <asp:Button ID="btnCompleteReturn" runat="server" Text="Complete Return" OnClick="btnCompleteReturn_Click" CssClass="btn_saless" />
                                    ...
                                    <td align="left" valign="top">
                                        ...
                                        <asp:Button ID="btnToReturns" runat="server" Text="Returns Home" OnClick="btnToReturns_Click" CssClass="btn_saless" />
