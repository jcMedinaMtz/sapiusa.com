<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeProductList.aspx.cs" Inherits="AgnesWS.Screens.EmployeeProductList" %>
...
<head runat="server">
    ...
    <title>Employee Product List</title>
...
<div id="titulo_100pe">
  <table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="40" align="left" valign="middle" class="titulo">Product List</td>
...
<td width="2.5%" align="left" valign="middle">&nbsp;</td>
 ...
 <td width="10%" align="left" valign="middle"><br>
             <asp:Button ID="btn_GetProducts" Text="Get Products" runat="server" CssClass="botonForm" OnClick="btn_GetProducts_Click"  />
   ...
   <table  width="900"  border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <asp:Panel ID="Panel1" runat="server"  ScrollBars="Both" style="width:900px;height:1000px;">
                <asp:GridView ID="ProductsGrid" DataSourceID="SQL_Products" runat="server" EmptyDataText="No Product Found"  DataKeyNames="ID" AutoGenerateColumns="false" AllowSorting="True" AllowPaging="true" OnSorting="ProductsGrid_Sorting" OnRowDataBound="ProductsGrid_RowDataBound" OnPageIndexChanging="ProductsGrid_PageIndexChanging" PageSize="50"   CssClass="Grid">
