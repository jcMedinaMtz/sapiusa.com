<%@ Page Language="C#" Title="Add Edit WorkOrders" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="WorkOrders.aspx.cs" Inherits="Printel.WorkOrders" %>
  ...
  <table id="Outertable" width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr> <!-- Inner table row 11 starts -->
                                  <td  height="35" align="center" valign="middle">
                                    ...
                                    <td width="20%" height="35"  align="center" valign="middle"><br /><br />
                                        ...
                                        <asp:HiddenField ID="hiddenproductidvalues" runat="server" Value="" />
                                         <asp:HiddenField ID="hiddenprojectidvalue" runat="server" Value="" />
                  ...
                  <td align="right" width="900px" valign="top">
                      <table id="Innertable2" width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <asp:GridView ID="ScheduledGrid" AutoGenerateColumns="false" ShowHeader="true" BorderColor="#197575" BorderStyle="None" BorderWidth="1px"   DataKeyNames="WorkOrderDetailID"     EmptyDataText="No Records returned"  runat="server" CssClass="Grid">
              ...
              <tr> <!--Outer table row 2 starts -->
    	           <td align="center" colspan="2" valign="top" width="600px">
                                  ...
                                  <td width="20%" height="35"  align="right" valign="middle"><br /><br />
                                     ...
                                     <asp:Button ID="btnToSchedule" runat="server" CausesValidation="false" Text="To Schedule" OnClick="btnToSchedule_Click"  CssClass="botonForm"/>
                                    </td>
