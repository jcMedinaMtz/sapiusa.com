<%@ Page Language="C#" Title="Login" AutoEventWireup="true"   MasterPageFile="~/Site1.Master" CodeBehind="Login.aspx.cs" Inherits="Printel.Screens.Login" %>
    ...
    <br />
      ...
      <table width="600px" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
         ...
         <tr>
            <td width="100px" align="right" valign="middle"> <br />
                <asp:Label ID="Label16" runat="server" Text="IsVendor?" CssClass="txt_login2"></asp:Label>
            </td>
            <td width="10px" height="30" align="left" valign="middle"> &nbsp;</td>
            <td width="80px" align="left" valign="middle"><br />
            <asp:CheckBox ID="CheckBoxVendor" runat="server"  />
            </td>
              <td width="200px" align="left" valign="middle"> <br />
            </td>
          </tr>
