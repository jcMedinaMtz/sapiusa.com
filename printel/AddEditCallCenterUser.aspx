<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="AddEditCallCenterUser.aspx.cs" Inherits="Printel.AddEditCallCenterUser" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <script type="text/javascript">
         function ValidateInputField()
         {
            // alert('Inside Javascript function ValidateInputField');
             var firstname = document.getElementById('<%=tb_ContactFirstName.ClientID%>').value;
             var salary = document.getElementById('<%=txtSalaryPerHour.ClientID%>').value;
             if(firstname=='')
             {
                 alert('Enter First Name');
                 return false;
             }
             var isnotvalidnumber = isNaN(salary);
             if (isnotvalidnumber)
             {
    ...
    <table id="Outertable" width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
    	           ...
    	           <td align="left" valign="top">
                        ...
                        <table id="Innertable" width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                                   ...
                                   <table width="350" border="0" cellspacing="0" cellpadding="0">
   	                              <tr>
   	                                <td width="120" align="right">
                                           <asp:Label ID="Label17" runat="server" Text="Salary Per Hour" CssClass="txt_login2"></asp:Label>
   	                                </td>
   	                                <td width="10" align="right">&nbsp;</td>
   	                                <td width="170">
                            ...
                            <td align="center" valign="middle" class="auto-style1"><br />
    	                     ...
    	                     <td height="35" align="left" colspan="6" valign="middle" class="auto-style1"><br />
                                  <table width="1000" border="0" cellspacing="0" cellpadding="0">
   	                              <tr>
   	                            
   	                                <td width="125" align="right"><asp:Label ID="Label15" runat="server" Text="Notes" CssClass="txt_login2"></asp:Label></td>
   	                                <td width="10" align="right">&nbsp;</td>
   	                                <td width="660" align="left">
                                         <asp:TextBox ID="txtNotes" runat="server" Width="630" Height="60px" TextMode="MultiLine" CssClass="form_Form"></asp:TextBox>
                    ...
                    <tr> <!-- Outertable row 2 starts -->
                                  <td  height="35" align="center" valign="middle">
                                    ...
                                    <td width="20%" height="35" align="right" valign="middle" ><br /><br />
                                         <asp:HiddenField ID="hiddenCallCenterUserID" runat="server" Value="" />
                                        <asp:Button ID="btnAddEditCallCenterEmployee" runat="server" Width="200px" CausesValidation="false" OnClientClick="return ValidateInputField();"  OnClick="btnAddEditCallCenterEmployee_Click" Text="Add/Edit Call Center User"  CssClass="botonForm"/>
                                    </td>
                                     
                                 <td width="20%" height="35" align="center" valign="middle" ><br /><br />
                                        <asp:Button ID="btnListOfCallCenterUsers" runat="server" Width="200px" CausesValidation="false" Text="List Of CallCenter Users " OnClick="btnListOfCallCenterUsers_Click"  CssClass="botonForm"/>
                                    </td>
    	           ...
    	           <td align="center" width="1000px" colspan="6" valign="top"> <br /> <br />
                       ...
                       <asp:Label ID="Label3" runat="server" Text="Add Credentials" Font-Bold="true" CssClass="txt_login2"></asp:Label>
                       <br />
                       <br />
                        <table id="Innertable2" width="800px" border="0" align="center" cellpadding="0" cellspacing="0">
   	                         <tr> <!-- Inner table2 row 1 starts -->
    	                     <td height="35" align="left" valign="middle" class="auto-style1"><br />
                               <table width="350" border="0" cellspacing="0" cellpadding="0">
   	                              <tr>
   	                             <td width="120" align="right"><asp:Label ID="Label13" runat="server" Text="Username" CssClass="txt_login2"></asp:Label></td>
   	                             <td width="10" align="right">&nbsp;</td>
    	                     ...
    	                     <td height="35" align="left" valign="middle" class="auto-style1"><br />
                                 <table width="350" border="0" cellspacing="0" cellpadding="0">
   	                              <tr>
   	                                <td width="120" align="right"><asp:Label ID="Label14" runat="server" Text="Password" CssClass="txt_login2"></asp:Label></td>
   	                                <td width="10" align="right">&nbsp;</td>
                              ...
                              <tr> <!-- Inner table2 row 2 starts -->
                                 ...
                                 runat="server"/>
                                    ...
                                    <br />   <br />
                                       ...
                                       <asp:RegularExpressionValidator ID="RegExp1" runat="server"   CssClass="txt_validate"   
